...
import com.qali.ashell.emulator.TerminalSession;
import com.qali.ashell.emulator.TerminalSession.SessionChangedCallback;
...
public class TerminalService extends Service implements SessionChangedCallback {
    ...
    private static final String INTENT_ACTION_SERVICE_STOP = "com.qali.ashell.ACTION_STOP_SERVICE";
    private static final String INTENT_ACTION_WAKELOCK_ENABLE = "com.qali.ashell.ACTION_ENABLE_WAKELOCK";
    private static final String INTENT_ACTION_WAKELOCK_DISABLE = "com.qali.ashell.ACTION_DISABLE_WAKELOCK";

    private static final int NOTIFICATION_ID = 1338;
    private static final String NOTIFICATION_CHANNEL_ID = "com.qali.ashell.NOTIFICATION_CHANNEL";
